...
SELECT * FROM analytics WHERE rating >= 4.8 ORDER BY desc limit 1;
...
SELECT SUM(reviews) AS "all" FROM Analytics;
...
FROM analytics WHERE MIN_INSTALLS >= 1000000 ORDER BY proportion DESC LIMIT 1;